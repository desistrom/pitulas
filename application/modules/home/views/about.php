	...
	<div class="feature-grid">
		<div class="container">
			...
			<div class="agileits-feature-grids">
				...
				<div class="col-sm-4 agileinfo-feature-grid">
					<div class="agileinfo-feature-info">
						<img src="<?=base_url().'assets/images/13.jpg';?>" alt="" />
		...
		<div class="container">
			...
			<div class="team-row">
					<div class="col-md-3 team-grids">
						<div class="team-img">
							<img class="img-responsive" src="<?=base_url().'assets/images/t1.jpg';?>" alt="">
							<div class="captn">
								<div class="captn-top">
									<h4>Edwards Doe</h4>
					...
					<div class="col-md-3 team-grids">
						<div class="team-img">
							<img class="img-responsive" src="<?=base_url().'assets/images/t2.jpg';?>" alt="">
							<div class="captn">
								<div class="captn-top">
									<h4>Mark Sophia</h4>
									<p>Aenean pulvinar ac enimet posuere tincidunt velit Utin tincidunt</p>
					...
					<div class="col-md-3 team-grids">
						<div class="team-img">
							<img class="img-responsive" src="<?=base_url().'assets/images/t3.jpg';?>" alt="">
							<div class="captn">
								<div class="captn-top">
									<h4>Michael amet</h4>
									<p>Aenean pulvinar ac enimet posuere tincidunt velit Utin tincidunt</p>
					...
					<div class="col-md-3 team-grids">
						<div class="team-img">
							<img class="img-responsive" src="<?=base_url().'assets/images/t4.jpg';?>" alt="">
							<div class="captn">
								<div class="captn-top">
									<h4>Daniel Nyari</h4>
									<p>Aenean pulvinar ac enimet posuere tincidunt velit Utin tincidunt</p>
