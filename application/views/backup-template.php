...
<body>
                    ...
                    <div class="container-f">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                <li <?php if($this->general->get_current_page() == 'homeindex' || $this->general->get_current_page() =='home' ) { ?> class="active" <?php } ?>>
                                    <a href="<?=site_url('home');?>">Home</a>
                                </li>
                                <li <?php if($this->general->get_current_page() == 'homeabout') { ?> class="active" <?php }  ?>>
                                ...
                                <li<?php if($this->general->get_current_page() == 'forumindex') { ?> class="active" <?php } ?>>
                                <a href="<?=site_url('forum');?>">Forums</a></li>
                                <?php if ($this->general->get_idRole() == 1) { ?>
                                <li<?php if($this->general->get_current_page() == 'trainer/propose') { ?> class="active" <?php } ?>>
                                <a href="<?=site_url('trainer/propose');?>">Propose Training</a></li> <?php } 
                                elseif($this->general->get_idRole() == 3) { ?> 
                                <li<?php if($this->general->get_current_page() == 'employer/propose') { ?> class="active" <?php } ?>>
                                <a href="<?=site_url('employer/propose');?>">Propose Job</a></li> <?php } ?>
                                <li><a href="page-contact.html">Contact</a></li>
                            </ul>

                            <ul class="nav navbar-nav navbar-right">
                            <?php  if($this->general->is_login()){?>
                                        <li class="dropdown has-submenu">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="fa fa-cog fa-spin fa-2x fa-fw"></span></a>
                                            <ul class="dropdown-menu show-right">
                                                <li class="dropdown "><a <?php if ($this->general->get_idRole() == 1) { ?>href="<?=site_url('trainer');?>"<?php } elseif($this->general->get_idRole() == 2) { ?> 
                                href="<?=site_url('employ');?>"<?php } else { ?>href="<?=site_url('employer');?>"<?php } ?>class="fa fa-user" role="button" >  Profile</a>
                                                </li>
                                                 <li>
                                ...
                                <li class="nav navbar-nav">
                                    <a href="<?=site_url('home/search')?>" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-search"></i></a>
                                </li>
    ...
    ?>
        <script type="text/javascript" src="<?=$file;?>?t=<?=time();?>"></script>
    <?php } }?>
        
    <script type="text/javascript" src="<?=base_url();?>assets/front/js/mycustom/front-end.js?t=<?=time();?>"></script>
